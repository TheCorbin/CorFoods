    ...
    <body class="foodItemsList">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <h1 id="title">Insert An Order</h1>
            ...
            <br>
        <form id="form1" name="form1" Method="POST" action="OrderController?action=insertFinal">
             <sec:authorize access="hasAnyRole('ROLE_MGR')">
            <fieldset>
                <p>
                        <label for="customerEmail"> Customer Email<Span> (Required, email format)</span></label>
                        <br>
                        <input id="customerEmail" name="customerEmail"  minlength="2" type="email" required/>
                    </p>
            <table id="foodItemListTable" style="width: 50%;" border="1" cellspacing="0" cellpadding="4">
                ...
                <tbody id="foodItemTblBody">
                    ...
                    <p>
                        ...
                        <br>
                        <input id="orderTotal" name="orderTotal" number="true" required/>
                    </p>
